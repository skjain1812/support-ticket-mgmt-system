...
- **Workflow artifacts:** Lifecycle docs, AI prompts, Cursor workflow files, and setup documentation
...
| Documentation | Filled templates for README, setup notes, PR description, reflection | Verified setup steps end-to-end |
...
- `ai-prompts/` — reusable prompt templates by activity (planning, implementation, testing, review)
